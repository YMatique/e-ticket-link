...
<head>
    ...
    <link href="{{ asset('template/html/layout_1/full/assets/css/ltr/all.min.css') }}" id="stylesheet" rel="stylesheet"
        type="text/css">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                <div class="navbar navbar-sm navbar-footer border-top">
                    <div class="container-fluid">
                        <span>&copy; {{ date('Y') }} <a href="{{ url('/') }}">CityLink e-Ticket</a> - Sistema
                            de Bilhetes Electrónicos</span>
